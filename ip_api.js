...
var title =flags.get(obj['countryCode']) + ' '+ City_ValidCheck(obj['country']) + ' '+ City_ValidCheck(obj['city']);//+Area_check(obj['country']);
var subtitle = obj['query'] + ' '+ 'ISP:'+ISP_ValidCheck(obj['isp']);
var ip = obj['query'];
